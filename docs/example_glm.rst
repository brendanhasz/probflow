...
:ref:`logistic <example_logistic_regression>` regression examples, we created
...
.. image:: img/examples/poisson_regression/output_4_0.svg
   :width: 99 %
   :align: center
...
.. image:: img/examples/poisson_regression/output_10_0.svg
   :width: 70 %
   :align: center
...
.. image:: img/examples/poisson_regression/output_15_2.svg
   :width: 70 %
   :align: center
